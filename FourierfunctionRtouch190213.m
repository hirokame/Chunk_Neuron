function FourierfunctionRtouch190213
%
%   詳細説明をここに記述
global  dpath3 tfile fnameACresult ACresultW CCresultDrinkOn SpikeArray RpegTouchallWon LpegTouchallWon TurnMarkerTime RmedianPTTM RpegMedian LmedianPTTM LpegMedian render...
    RpNum LpNum  OneTurnTime CCresultSpike locsP1time locsP2time locsP1time2 locsP2time2 fname tfile WaterOnArrayOriginal A1Rt A2Lt htouch phaseL phaseR OnePhaseLindex...
    pksP1 locsP1 pksP2 locsP2 OnePhaseRindex MaxA1Rt MaxA2Lt MaxZR MaxZL frequency mensekiR mensekiL
...
if render == 1
    ...
    [Ms,Is]=max(s);
    subplot(3,2,5)
    plot(linspace(0,1,bin1),phaseR);
    subplot(3,2,6)
    plot(linspace(0,1,bin1),phaseL);
...
PhaseRCell=[phaseR;linL(1:length(phaseR))];
[MPR locsMPR]=max(phaseR);
