...
% pathnameCSC = 'C:\Users\kit\Desktop\2010-1-17_20-46-17\CSC4.Ncs';
% pathnameCSC = 'C:\Users\kit\Desktop\CSC3.Ncs';
% pathnameCSC = 'C:\Users\kit\Documents\MATLABoriginal\CSC1.Ncs';
pathnameCSC = 'C:\Users\kit\Desktop\CheetahData\2016-2-2_17-15-29\CSC1.Ncs';
[Timestamp, ChanNum, SampleFrequency, NumValSamples, Samples, header] = Nlx2MatCSC(pathnameCSC, [1, 1, 1, 1, 1], 1, 1)%この式を使うだけ。functionとして使う必要は無い。
% [timestamps, lfp_Samples] = Nlx2MatCSC(pathnameCSC, [1, 0, 0, 0, 1], 0, 1);%この式を使うだけ。functionとして使う必要は無い。
