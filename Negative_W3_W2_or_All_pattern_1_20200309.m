function Negative_W3_W2_or_All_pattern_1_20200309
           ...
           if length(TrimFolder2)>22 && strcmp(TrimFolder2(end-21:end),'SpikeOnOffRtLtUnit.mat');
              ...
              W23RtouchUnitNegative=[];
               for x=1:length(LtouchUnitNegative(:,1));
                   if LtouchUnitNegative(x,4)==-1 || LtouchUnitNegative(x,3)==-1;
                      W23LtouchUnitNegative=[W23LtouchUnitNegative;LtouchUnitNegative(x,:)];
                   end
               end
               
               for x=1:length(RtouchUnitNegative(:,1));
                   if RtouchUnitNegative(x,4)==-1 || RtouchUnitNegative(x,3)==-1;
...
figname=['Lt_Positive_W23_or_ALL.bmp'];
figname2=['Rt_Positive_W23_or_ALL.bmp'];
cd(path)
