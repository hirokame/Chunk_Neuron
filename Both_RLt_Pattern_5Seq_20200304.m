function Both_RLt_Pattern_5Seq_20200304
...
RLtouchPoint=zeros(1,6);
RLtouchFire=zeros(1,6);
X=[];
...
set(gca,'xticklabel',{'12345','23456','34567','45678','56789','678910'});
title('MeanSumRLtouchUnit_Pattern_Sum');


figname=['Both_LtRt_Pattern_5Seq.bmp'];
cd(path)
saveas(Fig1,figname);
