function MSNcount20200108part2
a=0;
...
cd(pathdesktop)
namearray = {'MSN';'Rt';'Lt';'RtLt';'Touch';'Won';'Woff';'WonWoff';'Don';'WoDon';'tDon';'Wot';'tWoDon';'modBgra';'mod98';'rep';'Bgra98';'98rep'...
    ;'repBgra';'Rhythm(mt1)';'Rhythm(mt2)';'Rhythm(mt3)'};
countArray =[MSNsum;Rtcountsum;Ltcountsum;RtLtcountsum;Touchcountsum;Woncountsum;Woffcountsum;WonWoffcountsum;Doncountsum;WoDoncountsum;tDoncountsum;Wotcountsum;tWoDoncountsum...
