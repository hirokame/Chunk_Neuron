function CircularNetPilgrimNxRsA20160822
...
global Vreset Vth dt tau_m tmax Matrix
Neurons=5000;
% SRND=0.1;
RefPeriod=2;%ms?
Delay=1;%ms
...
iFile='M1_N1000_G50_E5_R-1_Match1000'
% iFile='M2_N1000_G50_E5_R-1_Match10000'
iFile='M3_N1000_G50_E5_R-1_Match100000'
% iFile='M4_N1000_G50_E5_R-1_Match1000000'
...
cd C:\Users\B133_2\Documents\MATLAB\GroupCMX\GroupCnxMatrix10000M4
...
Snet=(N-1)*(Neurons*0.01)^2*(100/Neurons);%5000,10000
...
%     RM=rand(Neurons,Neurons);
%     RM(RM>0.95)=1;RM(RM<=0.95)=0;
%     RM=RM-diag(diag(RM));
%     
%     CnxMatrix=RM*1;
%     
...
% % % % % % % % % % MeanCM=mean(mean(CnxMatrix(CnxMatrix>0)));
% % % % % % % % % % 
% % % % % % % % % % MedianCM=median(CnxMatrix(CnxMatrix>0));
% % % % % % % % % % 
% % % % % % % % % % % CnxMatrixAll(ExtNeurons,ExtNeurons)=CnxMatrix*0.01;
% % % % % % % % % % 
% % % % % % % % % % ratio=1/MeanCM*5.5/20;%
...
%     NeuronsEI=Neurons+length(InhNeurons);

% CnxMatrixAdd=zeros(Neurons+length(InhNeurons),Neurons+length(InhNeurons));
% MeanW=median(median(CnxMatrix));
% Wie=0.00001;
% Wei=0.00001;
% Wii=0.00001;
% CnxMatrixAll=zeros(Neurons+length(InhNeurons),Neurons+length(InhNeurons));
% CnxMatrixAll(Neurons+1:end,Neurons+1:end)=MeanW*0.01;%from inh to inh
% CnxMatrixAll(Neurons+1:end,1:Neurons)=MeanW*0.01;%from ext to inh
% CnxMatrixAll(1:Neurons,Neurons+1:end)=MeanW*0.01;%from inh to ext
    

% InSize=200;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% InSize=0.000001;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% InSize=0.000001*200000;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
