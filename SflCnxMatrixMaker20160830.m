function SflCnxMatrixMaker20160830%(File,ExpMatrix,ProbMatrix,CnxMatrix,VarMatrix)
...
File='Group_CnxMatrix001_M2_N10000_G50_E5_R1_Match1000000';
File='Group_CnxMatrix001_M1_N10000_G50_E5_R1_Match1000000';
File='Group_CnxMatrix001_M3_N10000_G50_E5_R1_Match1000000';
...
%         Neurons
    ...
    %         str2=['save ',File,',IdealMatrix',int2str(Neurons),',IdealSflMatrix',int2str(Neurons),',IdealSflPrMatrix',int2str(Neurons),',CnxMatrix',int2str(Neurons),',SflCnxMatrix',int2str(Neurons),',SflPrCnxMatrix',int2str(Neurons), ',RndMatrix',int2str(Neurons),',EvenMatrix',int2str(Neurons), ',''','-append;',''''];
            ...
            str2=['save ',File,',CnxMatrix',int2str(Neurons),',SflCnxMatrix',int2str(Neurons),',SflPrCnxMatrix',int2str(Neurons),',''','-append;',''''];
            eval(str2);
        end
