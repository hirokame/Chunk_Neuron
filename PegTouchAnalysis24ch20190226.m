function PegTouchAnalysis24ch20190226(R_PegTouchCell,L_PegTouchCell,SliderTouch,TurnMarkerTime,OneTurnTime,RpegTimeArray2D,LpegTimeArray2D,FTselect)
...
global SliderTouch OneTurnTime RefPeriod RpegMedian LpegMedian RLpegMedian RLpegName DrName fig_touchR fig_touchL fig_touchR_TM fig_touchL_TM fig_TMpegs...
    ...
    VoltAnalysis TouchTiming DetachTiming DrinkTiming RpNum LpNum RPegTouchAll LPegTouchAll Max fname RmedianPTTM LmedianPTTM
...
%     for n=1:12;plot(PTTMHistoCell_L{n},'r');end%text(LmedianPTTM(n),Max+2,'l','FontSize',18,'r');end;
    ...
    RmedianPTTM98=RmedianPTTM;
    LmedianPTTM98=LmedianPTTM;
    OneTurnTime98=OneTurnTime;
    RpegMedian98=RpegMedian;
    LpegMedian98=LpegMedian;
    save(Touchfile,'RmedianPTTM98','LmedianPTTM98','OneTurnTime98','RpegMedian98','LpegMedian98');
    end
%     save(Touchfile,'RpegTouchallWon','LpegTouchallWon','OneTurnTime','RpegMedian','LpegMedian','TurnMarkerTime');
% end
