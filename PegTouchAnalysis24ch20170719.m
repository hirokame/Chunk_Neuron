...
global SliderTouch OneTurnTime RefPeriod RpegMedian LpegMedian RLpegMedian RLpegName DrName fig_touchR fig_touchL fig_touchR_TM fig_touchL_TM fig_TMpegs...
    ...
    RpegTimeArray2D_turn LpegTimeArray2D_turn fig_TouchRL fig_TouchR fig_TouchL RtouchHist LtouchHist RLtouchHist TurnMarkerTime VoltAnalysis

% % % % % rPegTouchCell=cell(1,1);
% % % % % k=1;
% % % % % for n=1:length(R_PegTouchCell)
% % % % %     if length(R_PegTouchCell{n})>length(TurnMarkerTime)/3
% % % % %         rPegTouchCell{k}= R_PegTouchCell{n};
% % % % %         k=k+1;
% % % % %     end
% % % % % end
% % % % % R_PegTouchCell=rPegTouchCell;
% % % % % lPegTouchCell=cell(1,1);
% % % % % k=1;
% % % % % for n=1:length(L_PegTouchCell)
% % % % %     if length(L_PegTouchCell{n})>length(TurnMarkerTime)/3
% % % % %         lPegTouchCell{k}= L_PegTouchCell{n};
% % % % %         k=k+1;
% % % % %     end
% % % % % end
% % % % % L_PegTouchCell=lPegTouchCell;
...
% % % % % RpatternMatrix=zeros(1,length(RpegTimeArray2D_turn(1,:)));
% % % % % LpatternMatrix=zeros(1,length(LpegTimeArray2D_turn(1,:)));
% % % % % PEGpattern=zeros(1,length(TurnMarkerTime));
% % % % % 
% % % % % k=1;
...
% % % % %         for p=1:k
% % % % %             
% % % % %             Diff(p)=sum(abs(RpatternMatrix(p,:)-A))+sum(abs(LpatternMatrix(p,:)-B));
% % % % %             
% % % % %         end
% % % % %         for p=1:length(Diff)
% % % % %             
% % % % %             if min(Diff)>OneTurnTime*0.3
% % % % %                 k=k+1;
% % % % %                 Max=find(Diff==max(Diff));
% % % % %                 
% % % % % %                 if Max>length(RpatternMatrix(:,1))
% % % % % %                     k=k+1;
% % % % %                     RpatternMatrix(k,:)=A;%RpegTimeArray2D_turn(n,:);
% % % % %                     LpatternMatrix(k,:)=B;%LpegTimeArray2D_turn(n,:);
% % % % %                     if k==3
% % % % %                         k
% % % % %                     end
% % % % %                     PEGpattern(n)=Max(1);
% % % % %                 else
% % % % %                     Min=find(Diff==min(Diff));
% % % % %                     PEGpattern(n)=Min(1);
% % % % % %                 end
% % % % %             end
% % % % %             
...
%    a=TurnMarkerTime(m)        
%    b=SliderTouch(n+12)
%    c=TurnMarkerTime(m)+SliderTouch(n+12)*OneTurnTime 
%    d=TurnMarkerTime(m)+SliderTouch(n+12)*OneTurnTime+Duration
%    e=L_PegTouchCell{n}
%    if n==6
%        e
%    end
