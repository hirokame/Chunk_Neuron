...
%%%%%%% Threshold %%%%%%%%
Cell_th = 1.0;    % 0.5 for MSN
MaxZR_th = 13;     % 18 for MSN
MaxA1Rt_th = 0.05; % 0.2 for MSN
MaxZL_th = 13;     % 20 for MSN
MaxA2Lt_th = 0.05; % 0.4 for MSN
Beta_th = 0.3;
Rsq_th = 0.92;
%%%%%%%%%%%%%%%%%%%%%%%%%%
