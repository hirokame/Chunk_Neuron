function  untitled20191024
%仮説２：スパイクがあった直後のタッチからスパイクまでの時間を用いた予測
%untitled20190311からの変更点：1000ビンに直すところjMaxの値を小数第一位までに変更、ヒルベルト変換を使わないようにした
global  ACresult ACresultW CCresultDrinkOn SpikeArray TurnMarkerTime RpegTouchallWon LpegTouchallWon...
    ...
    fig FLName EnveRLPhaseTM EnveCCresultSpikePro  meanKldistDiff KldistSame dpath KLD2 meanXaxiserror2 Envedist2 meanXaxiserror Envedist
...
% % 包絡線
% x = hilbert(avgCCresultSpikePro);%%%%%%%%%%%%%%%%%%%%%%%%%%%ヒルベルト変換使用しない                                                                 
...
plot(linspace(0,OneTurnTime98*2,length(EnveCCresultSpikePro)),EnveCCresultSpikePro,'color','k');%off %色20200210変更
...
meanXaxiserror2=meanXaxiserror;
Envedist2=Envedist;
