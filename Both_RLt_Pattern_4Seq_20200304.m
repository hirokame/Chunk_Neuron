function Both_RLt_Pattern_4Seq_20200304
...
RLtouchPoint=zeros(1,7);
RLtouchFire=zeros(1,7);
X=[];
...
set(gca,'xticklabel',{'1234','2345','3456','4567','5678','6789','78910'});
title('MeanSumRLtouchUnit_Pattern_4Seq');


figname=['Both_LtRt_Pattern_4Seq.bmp'];
cd(path)
saveas(Fig1,figname);
