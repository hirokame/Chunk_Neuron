function RepeatFig20170612
close all

global Repeat MaxRepeat K
%XXX　o11ooとoo11oで最も高い部分を探して、そこを中心に10bin四方くらい？の範囲で合計値を求める
% o111oの真ん中で最も高い部分を探す。
%　それぞれの領域について、oo1oo、o11oo、oo11o、o111o、1111o、o1111、11111での値を求める。
%　

% cd C:\Users\B133_2\Desktop\MatFig\11911_170607aSc8_SS_05
cd C:\Users\B133_2\Desktop\MatFig\2611_170622aSc4_SS_02

% rFileName='11911_170607';
rFileName='2611_170622';
load(rFileName);

TouchID=6;%RightTouch=6, Left=7, R&L=8.
...
global Repeat K SEoo1oo SEo11oo SEoo11o SEo111o SE1111o SEo1111 SE11111 SE00100 SE01100 SE00110 SE11100 SE01110 SE00111 SE11110 SE01111 SE11111...
...
[a b]=find(SEo11oo==(max(max(SEo11oo(AL+1:end-AL-1,AL+1:end-AL-1)))));
[c d]=find(SEoo11o==(max(max(SEoo11o(AL+1:end-AL-1,AL+1:end-AL-1)))));
% [e f]=find(SEo111o==(max(max(SEo111o(AL+1:end-AL-1,AL+1:end-AL-1)))));
[g h]=find(SE01110==(max(max(SE01110(AL+1:end-AL-1,AL+1:end-AL-1)))));
...
HighArea_o111oValue(4)=sum(sum(SEo111o(e-AL:e+AL,f-AL:f+AL)));
HighArea_o111oValue(1)=sum(sum(SEoo1oo(e-AL:e+AL,f-AL:f+AL)));
HighArea_o111oValue(2)=sum(sum(SEo11oo(e-AL:e+AL,f-AL:f+AL)));
HighArea_o111oValue(3)=sum(sum(SEoo11o(e-AL:e+AL,f-AL:f+AL)));

% HighArea_oo11oValue(5)=sum(sum(SE1111o(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(5)=sum(sum(SE1111o(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(5)=sum(sum(SE1111o(e-AL:e+AL,f-AL:f+AL)));
% HighArea_oo11oValue(6)=sum(sum(SEo1111(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(6)=sum(sum(SEo1111(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(6)=sum(sum(SEo1111(e-AL:e+AL,f-AL:f+AL)));
% HighArea_oo11oValue(7)=sum(sum(SE11111(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(7)=sum(sum(SE11111(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(7)=sum(sum(SE11111(e-AL:e+AL,f-AL:f+AL)));
% HighArea_oo11oValue(8)=sum(sum(SE00100(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(8)=sum(sum(SE00100(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(8)=sum(sum(SE00100(e-AL:e+AL,f-AL:f+AL)));
% HighArea_oo11oValue(9)=sum(sum(SE01100(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(9)=sum(sum(SE01100(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(9)=sum(sum(SE01100(e-AL:e+AL,f-AL:f+AL)));
% HighArea_oo11oValue(10)=sum(sum(SE00110(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(10)=sum(sum(SE00110(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(10)=sum(sum(SE00110(e-AL:e+AL,f-AL:f+AL)));
% HighArea_oo11oValue(11)=sum(sum(SE11100(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(11)=sum(sum(SE11100(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(11)=sum(sum(SE11100(e-AL:e+AL,f-AL:f+AL)));
% HighArea_oo11oValue(12)=sum(sum(SE00111(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(12)=sum(sum(SE00111(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(12)=sum(sum(SE00111(e-AL:e+AL,f-AL:f+AL)));


% HighArea_oo11oValue(13)=sum(sum(SE01110(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(13)=sum(sum(SE01110(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(13)=sum(sum(SE01110(e-AL:e+AL,f-AL:f+AL)));
% HighArea_oo11oValue(14)=sum(sum(SE11110(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(14)=sum(sum(SE11110(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(14)=sum(sum(SE11110(e-AL:e+AL,f-AL:f+AL)));
% HighArea_oo11oValue(15)=sum(sum(SE01111(c-AL:c+AL,d-AL:d+AL)));
% HighArea_o11ooValue(15)=sum(sum(SE01111(a-AL:a+AL,b-AL:b+AL)));
HighArea_o111oValue(15)=sum(sum(SE01111(e-AL:e+AL,f-AL:f+AL)));
...
HighArea_01110Value(7)=sum(sum(SE11111(e-AL:e+AL,f-AL:f+AL)));
HighArea_01110Value(8)=sum(sum(SE00100(e-AL:e+AL,f-AL:f+AL)));
HighArea_01110Value(9)=sum(sum(SE01100(e-AL:e+AL,f-AL:f+AL)));
HighArea_01110Value(10)=sum(sum(SE00110(e-AL:e+AL,f-AL:f+AL)));
HighArea_01110Value(11)=sum(sum(SE11100(e-AL:e+AL,f-AL:f+AL)));
HighArea_01110Value(12)=sum(sum(SE00111(e-AL:e+AL,f-AL:f+AL)));
HighArea_01110Value(13)=sum(sum(SE01110(e-AL:e+AL,f-AL:f+AL)));
HighArea_01110Value(14)=sum(sum(SE11110(e-AL:e+AL,f-AL:f+AL)));
HighArea_01110Value(15)=sum(sum(SE01111(e-AL:e+AL,f-AL:f+AL)));
% SEoo1oo SEo11oo SEoo11o SEo111o SE1111o SEo1111 SE11111 SE00100 SE01100 SE00110 SE11100 SE00111 SE01110 SE11110 SE01111

HighArea123in3(1)=sum(sum(SE1in3(e-AL:e+AL,f-AL:f+AL)));
HighArea123in3(2)=sum(sum(SE2in3(e-AL:e+AL,f-AL:f+AL)));
HighArea123in3(3)=sum(sum(SE3in3(e-AL:e+AL,f-AL:f+AL)));
HighArea123_234in4(1)=sum(sum(SEtop1in4(e-AL:e+AL,f-AL:f+AL)));
HighArea123_234in4(2)=sum(sum(SEtop2in4(e-AL:e+AL,f-AL:f+AL)));
HighArea123_234in4(3)=sum(sum(SEtop3in4(e-AL:e+AL,f-AL:f+AL)));
HighArea123_234in4(4)=sum(sum(SElast3in4(e-AL:e+AL,f-AL:f+AL)))
HighArea123_234in4(5)=sum(sum(SElast2in4(e-AL:e+AL,f-AL:f+AL)));
HighArea123_234in4(6)=sum(sum(SElast3in4(e-AL:e+AL,f-AL:f+AL)));
